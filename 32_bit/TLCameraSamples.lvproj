...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Hardware triggered acquisition - polling.vi" Type="VI" URL="../Hardware triggered acquisition - polling.vi"/>
		<Item Name="Image acquisition color 8-bit RGB - polling.vi" Type="VI" URL="../Image acquisition color 8-bit RGB - polling.vi"/>
		<Item Name="Image acquisition color 16-bit RGB data - polling.vi" Type="VI" URL="../Image acquisition color 16-bit RGB data - polling.vi"/>
		<Item Name="Image acquisition polarization camera - polling.vi" Type="VI" URL="../Image acquisition polarization camera - polling.vi"/>
		<Item Name="OnDiagnosticsMessage Event Callback.vi" Type="VI" URL="../OnDiagnosticsMessage Event Callback.vi"/>
		<Item Name="OnImageFrameAvailable Event Callback - 16-bit.vi" Type="VI" URL="../OnImageFrameAvailable Event Callback - 16-bit.vi"/>
		<Item Name="OnImageFrameAvailable Event Callback - TLCamera Main Color.vi" Type="VI" URL="../OnImageFrameAvailable Event Callback - TLCamera Main Color.vi"/>
		<Item Name="Simple image acquisition mono - events.vi" Type="VI" URL="../Simple image acquisition mono - events.vi"/>
		<Item Name="Simple image acquisition mono - polling.vi" Type="VI" URL="../Simple image acquisition mono - polling.vi"/>
		<Item Name="Software triggered acquisition - polling.vi" Type="VI" URL="../Software triggered acquisition - polling.vi"/>
		<Item Name="Status - Main.ctl" Type="VI" URL="../Status - Main.ctl"/>
		<Item Name="TLCamera Main.vi" Type="VI" URL="../TLCamera Main.vi"/>
